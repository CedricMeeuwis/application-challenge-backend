    ...
    public class DBInitializer
    {
        public static void Initialize(ChallengeContext context)
        {
            ...
            context.Users.AddRange(
                //Kapiteinen
                new User { Email = "aa@test.be", Naam = "Andre Andermans",  Geboortedatum = DateTime.Now.AddDays(-7000), Passwoord = "test", PloegID = 1},
                new User { Email = "bb@test.be", Naam = "Barry Barrens", Geboortedatum = DateTime.Now.AddDays(-7000), Passwoord = "test", PloegID = 2 },
                new User { Email = "cc@test.be", Naam = "Connie Conners", Geboortedatum = DateTime.Now.AddDays(-7000), Passwoord = "test", PloegID = 3 },
                new User { Email = "dd@test.be", Naam = "David Deckers", Geboortedatum = DateTime.Now.AddDays(-7000), Passwoord = "test", PloegID = 4 },
                //Gebruikers
                ...
                new User { Email = "kapitein@test.be", Naam = "Kapitein Test", Geboortedatum = DateTime.Now.AddDays(-7000), Passwoord = "test" },
                new User { Email = "gebruiker@test.be", Naam = "Gebruiker Test", Geboortedatum = DateTime.Now.AddDays(-7000), Passwoord = "test" },
                new User { Email = "admin@test.be", Naam = "Admin Test", Geboortedatum = DateTime.Now.AddDays(-7000), Passwoord = "test" }
            ...
            for (int i = 1; i <= 4; i++)
            {
                var ploeg = context.Ploegen.FirstOrDefault(p => p.PloegID == i);
                var kapitein = context.Users.FirstOrDefault(u => u.PloegID == i);

                ploeg.KapiteinID = kapitein.UserID;
            }
            context.SaveChanges();
